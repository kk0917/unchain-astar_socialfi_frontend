      ...
      <div className="flex-row items-end flex">
        ...
        <div className="mt-3">
          <div className="flex-row flex items-center">
            ...
            {is_me ? (
              <div className="border-t-transparent border-b-[10px] border-b-transparent border-l-[20px] border-l-blue-500" />
            ) : null}
          </div>
        </div>
    ...
    <div className="w-full justify-start items-end flex mt-3 mb-1">
      <div className="flex- flex items-center">
        ...
        <div className="flex-row flex items-end justify-start">
          <div className='mt-3'>
            <div className="flex-row flex  items-center">
              <div className="border-t-transparent border-b-[15px] border-b-transparent border-r-[20px] border-r-blue-500 " />
              <div className="bg-blue-500 py-1 px-3 rounded max-w-[230px]">
                <div>{props.message}</div>
              </div>
            </div>
